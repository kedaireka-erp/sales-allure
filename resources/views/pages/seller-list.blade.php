                            ...
                            <td class="!py-3.5">
                                <div class="flex items-center">
                                    <div class="w-9 h-9 image-fit zoom-in">
                                        <img alt="Midone - HTML Admin Template" class="rounded-lg border-white shadow-md tooltip" src="{{ asset('dist/images/' . $faker['photos'][0]) }}" title="Uploaded at {{ $faker['dates'][0] }}">
                                    </div>
                                    <div class="ml-4">
