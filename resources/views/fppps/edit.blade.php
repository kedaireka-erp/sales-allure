            ...
            <div class="intro-y box p-5">
                ...
                <div class="mt-5">
                    ...
                    <select data-placeholder="Pilih No. Quotation" class="tom-select w-full" id="quotation"
                        ...
                        <option value="{{ $quotation->id }}" {{ $quotation->id == $fppp->quotation_id ? 'selected' : ''
                            }}>
                ...
                <div class="mt-5">
                    ...
                    <select data-placeholder="Pilih Status Order" class="tom-select w-full" id="order_status"
                        ...
                        <option {{ $fppp->order_status == 'revisi' ? 'selected' : '' }} value="revisino">Revisi
                        </option>
                        <option {{ $fppp->order_status == 'lain-lain' ? 'selected' : '' }} value="lainlain">Lain-Lain
                        </option>
                    </select>
                </div>
                ...
                <div class="mt-5 hidden" id="catatan_status_order">
                    ...
                    <div class="mt-2">
                        <textarea name="fppp_keterangan" cols="30" rows="10"
                            class="editor ">{!! old('fppp_keterangan', $fppp->fppp_keterangan) !!}</textarea>
                    </div>
                </div>
                ...
                <div class="mt-5">
                    ...
                    <select data-placeholder="Pilih Kaca" class="tom-select w-full" id="glass" name="glass" single>
                        ...
                        <option {{ $fppp->glass == 'included & excluded' ? 'selected' : '' }} value="included_excluded">
                ...
                <div class="mt-5">
                    ...
                    <input id="retrieval_deadline" type="date" class="form-control w-full" placeholder="Input Tanggal "
                        name="retrieval_deadline" value="{{ $fppp->retrieval_deadline }}">
                </div>
                <div class="mt-5">
                    ...
                    <select data-placeholder="Pilih Penggunaan Peti" class="tom-select w-full" id="box_usage"
                        ...
                        <option {{ $fppp->box_usage == 'tidak' ? 'selected' : '' }} value="0">Tidak</option>
                        <option {{ $fppp->box_usage == 'ya' ? 'selected' : '' }} value="1">Ya</option>
                    </select>
                </div>
                <div class="mt-5">
                    ...
                    <select data-placeholder="Pilih Penggunaan Sealant" class="tom-select w-full" id="sealant_usage"
                        ...
                        <option {{ $fppp->sealant_usage == 'tidak' ? 'selected' : '' }} value="0">Tidak</option>
                        <option {{ $fppp->sealant_usage == 'ya' ? 'selected' : '' }} value="1">Ya</option>
                    </select>
                </div>
                <div class="mt-5">
                    ...
                    <select data-placeholder="Pilih Pengiriman ke Ekspedisi" class="tom-select w-full"
                        ...
                        <option {{ $fppp->delivery_to_expedition == 'tidak' ? 'selected' : '' }} value="0">Tidak
                        </option>
                        <option {{ $fppp->delivery_to_expedition == 'ya' ? 'selected' : '' }} value="1">Ya
                        </option>
                    </select>
                </div>
                <div class="mt-5">
                    ...
                    <div class="mt-2">
                        <textarea name="note" id="note" cols="30" rows="10"
                            class="editor">{!! old('note', $fppp->note) !!}</textarea>
                    </div>
                </div>
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-10 gap-5 pl-4 pr-5">
                                ...
                                <div class="col-span-5 md:col-span-2 h-28 relative image-fit cursor-pointer zoom-in">
                                    <img class="rounded-md" src="{{ asset('storage/' . $file->path) }}"
                                        alt="{{ $file->name }}" srcset="">
                                    <a href="#" title="Delete this file?"
                                        onclick="event.preventDefault(); document.querySelector('#delete_form').submit()"
