        ...
        <div class="mt-1 w-full flex flex-col gap-y-3">
            <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                ...
                <div class=" w-full">
                    ...
                    <div class=" font-semibold text-slate-500" {{ $fppp->fppp_type == 'produksi' ? 'selected' : '' }}
                        value="produksi">Produksi</div>
                    @else
            ...
            <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                ...
                <div class=" w-full">
                    <div class=" font-semibold text-slate-500">{{ $fppp->quotation->no_quotation ?? '' }}
                    </div>
                </div>
            </div>
            <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
            ...
            <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                ...
                <div class=" w-full">
                    <div class=" font-semibold text-slate-500">{{ $fppp->quotation->nama_proyek ?? '' }}
                    </div>
                </div>
            </div>
            <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full ">
            ...
            <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                ...
                <div class=" w-full">
                    ...
                    <div class=" font-semibold text-slate-500" {{ $fppp->order_status == 'revisino' ? 'selected' : '' }}
                        value="revisino">Revisi dari FPPP
