...
@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            ...
            <a href="{{ route('fppps.topdf', $fppp) }}" class="btn btn-primary shadow-md mr-2">
                <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Export PDF</i>
            </a>
        </div>
    </div>
            ...
            <div class="mt-1 w-full flex flex-col gap-y-3">
                <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                    <div class="w-1/3 max-w-1/2 flex flex-row justify-between">
                        <div class=" text-slate-500">Tipe FPPP </div>
                        <div class=" text-slate-500">:</div>
                    </div>
                    <div class=" w-full">
                        @if ($fppp->fppp_type == 'produksi')
                            <div class=" font-semibold text-slate-500"
                                {{ $fppp->fppp_type == 'produksi' ? 'selected' : '' }} value="produksi">Produksi</div>
                        @else
                            <div class=" font-semibold text-slate-500" {{ $fppp->fppp_type == 'memo' ? 'selected' : '' }}
                                value="memo">Memo</div>
                        @endif
                    </div>
                </div>
                <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                    ...
                    <div class=" w-full">
                        <div class=" font-semibold text-slate-500">{{ $fppp->quotation->DataQuotation->no_quotation ?? '' }}
                        </div>
                    </div>
                </div>
                <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                ...
                <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                    ...
                    <div class=" w-full">
                        <div class=" font-semibold text-slate-500">{{ $fppp->quotation->DataQuotation->nama_proyek ?? '' }}
                        </div>
                    </div>
                </div>
                <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full ">
                    ...
                    <div class=" w-full">
                        <div class=" font-semibold text-slate-500">
                            {{ $fppp->quotation->DataQuotation->alamat_proyek ?? '' }}
                        </div>
                    </div>
                </div>
                <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                ...
                <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                    ...
                    <div class=" w-full">
                        <div class=" font-semibold text-slate-500">{{ ucfirst($fppp->glass) }}</div>
                    </div>
                </div>
                <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                    <div class="w-1/3 max-w-1/2 flex flex-row justify-between">
                ...
                <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                    ...
                    <div class=" w-full">
                        <div class=" font-semibold text-slate-500">{{ ucfirst($fppp->box_usage) }}</div>
                    </div>
                </div>
                <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                    <div class="w-1/3 max-w-1/2 flex flex-row justify-between">
                    ...
                    <div class=" w-full">
                        <div class=" font-semibold text-slate-500">{{ ucfirst($fppp->sealant_usage) }}</div>
                    </div>
                </div>
                <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                    <div class="w-1/3 max-w-1/2 flex flex-row justify-between">
                    ...
                    <div class=" w-full">
                        <div class=" font-semibold text-slate-500">{{ ucfirst($fppp->delivery_to_expedition) }}</div>
                    </div>
                </div>
                <div class="flex gap-x-2 text-sm lg:text-base flex-row px-5 sm:px-20 w-full">
                    <div class="w-1/3 max-w-1/2 flex flex-row justify-between">
        ...
        <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
            ...
            <div class="mt-5">
                <div class="flex items-center text-slate-500">
                    ...
                    <div class="ml-2">
                        <span class="mr-1">Avoid selling counterfeit products / violating Intellectual Property Rights,
                            so
                            ...
                            <div class="grid grid-cols-10 gap-5 pl-4 pr-5">
                                @foreach ($fppp->files as $file)
                                    <div class="col-span-5 md:col-span-2 h-28 relative image-fit cursor-pointer zoom-in">
                                        ...
                                        <a href="{{ route('fppps.attachment.download', $file) }}"
