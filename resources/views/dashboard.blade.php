    ...
    <div class="col-span-12 2xl:col-span-9">
        <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="flex">
                            <div>
                                <div class="text-primary dark:text-slate-300 text-lg xl:text-xl font-medium">
                                    @currency($quo_nominal_this_month)
                                </div>
                            ...
                            <div>
                                <div class="text-slate-500 text-lg xl:text-xl font-medium">
                                    @currency($quo_nominal_last_month)
                                </div>
            ...
            <div class="col-span-12 md:col-span-6  mt-6">
                ...
                <div class="mt-5">
                    @foreach ($top_weekly_sellers as $seller)
                    <div class="intro-y">
                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                @if ($seller->photo)
                                <img alt="Midone - HTML Admin Template" src="{{ $seller->getPhotoUrlAttribute() }}">
                                @else
                                <img alt="Midone - HTML Admin Template"
                                    src="https://ui-avatars.com/api/?name={{ $seller->name }}">
                                @endif
                            </div>
                            <div class="ml-4 mr-auto">
                                <div class="font-medium">{{ $seller->name }}</div>
                                {{-- <div class="text-slate-500 text-xs mt-0.5">{{ $seller->email }}</div> --}}
                            </div>
                            <div
                                class="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">
                                {{ $seller->approachments_count }} Deals</div>
                        </div>
                    </div>
                    @endforeach
                    {{-- <a href=""
            ...
            <div class="col-span-12 md:col-span-6  2xl:col-span-12 mt-3 2xl:mt-8">
                <div class="intro-x flex items-center h-10">
                    <h2 class="text-lg font-medium truncate mr-5">Recently Added Quotation</h2>
                </div>
                <div class="mt-5">
                    @foreach ($latest_five_quotation as $quo)
                    <div class="intro-x">
                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                            ...
                            <div class="ml-4 mr-auto">
                                <div class="font-medium">{{ $quo->no_quotation }}</div>
                                <div class="text-slate-500 text-xs mt-0.5">{{ $quo->created_at->translatedFormat('d F Y') }}
                                </div>
                            </div>
                            <div class="text-success">
                                @currency($quo->nominal)
                            </div>
                        </div>
                    </div>
                    @endforeach
