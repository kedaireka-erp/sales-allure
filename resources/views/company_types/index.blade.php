...
@section('subcontent')
<h1 class="intro-y text-xl font-md mt-10 ">COMPANY TYPES</h1>
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a href="{{ route('company_types.create') }}" class="btn btn-primary shadow-md mr-2">Tambah Company Type</a>
        <div class="dropdown">
        ...
        <table class="table table-report -mt-2">
            ...
            <tbody>
                ...
                <tr class="intro-x zoom-in transition">
                    <td>{{ $no + $company_types->firstItem() }}</td>
                    <td>{{ $type->name }}</td>
    ...
    <!-- END: Data List -->
    <!-- BEGIN: Pagination -->
    {{ $company_types->links('components.custom-pagination') }}
    <!-- END: Pagination -->
</div>
