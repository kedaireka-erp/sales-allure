            ...
            <div class="intro-y col-span-12 lg:col-span-6">
                <div class="intro-y box p-5">
                    <div>
                        ...
                        <input id="name" type="text" name="name" class="form-control w-full" value="{{ $status->name }}"
                            placeholder="Masukkan nama status">
                    </div>
                    <div class="mt-3">
                        <label for="deskripsi" class="form-label">Deskripsi</label>
                            <div class="input-group mb-3">
                                <textarea name="deskripsi" type="text" class="form-control" id="deskripsi">{{ $status->deskripsi }}</textarea>
                            </div>
                    </div>
