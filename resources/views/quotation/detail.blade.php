...
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
        ...
        <a href="{{ route('fppps.create', $quotation) }}" class="btn btn-primary shadow-md mr-2">
    ...
    <div class="border-b border-slate-200/60 dark:border-darkmode-400 text-center sm:text-left">
        <div class="px-5 py-10 sm:px-20 sm:py-20 w-full flex justify-between">
            ...
            <div class="flex flex-col items-center h-full">
                ...
                <h2 class="text-primary font-semibold lg:text-lg text-base">Quotation No. {{
                    $quotation->no_quotation ?? '' }}</h2>
            </div>
        ...
        <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5">
            <div class="mt-5 w-full flex flex-col text-sm lg:text-base gap-y-3">
                ...
                <div class="flex gap-x-2 flex-row px-5 sm:px-20 w-full">
                    ...
                    <div class=" w-full">
                        <div class="text-base font-semibold text-slate-500">{{ $quotation->Contact->Company->name ?? ''
                            }}</div>
                    </div>
                </div>
                <div class="flex gap-x-2 flex-row px-5 sm:px-20 w-full">
                    ...
                    <div class=" w-full">
                        <div class="text-base font-semibold text-slate-500">{{ $quotation->nama_proyek ??
                            '' }}</div>
                    </div>
                </div>
                <div class="flex gap-x-2 flex-row px-5 sm:px-20 w-full">
                    ...
                    <div class=" w-full">
                        <div class="text-base font-semibold text-slate-500">{{ $quotation->Aplikator->aplikator ?? '' }}
                        </div>
                    </div>
                </div>
                <div class="flex gap-x-2 flex-row px-5 sm:px-20 w-full">
                ...
                <div class="flex gap-x-2 flex-row px-5 sm:px-20 w-full">
                    ...
                    <div class=" w-full">
                        <div class="text-base font-semibold text-slate-500">{{ $quotation->DealSource->name ?? '' }}
                        </div>
                    </div>
                </div>
                <div class="flex gap-x-2 flex-row px-5 sm:px-20 w-full">
