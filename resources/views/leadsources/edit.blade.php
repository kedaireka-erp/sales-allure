            ...
            <form action="{{ route('leadsources.update', $leadSource->id) }}" method="POST">
                ...
                <div class="intro-y box p-5">
                    <div>
                        ...
                        <input id="name" name="name" type="text" class="form-control w-full" value="{{ $leadSource->name }}">
                    </div>
                    <div class="mt-3">
                        <label for="description" class="form-label">Deskripsi</label>
                            <div class="input-group mb-3">
                                <textarea name="description" type="text" class="form-control" id="description">{{ $leadSource->description }}</textarea>
                            </div>
                    </div>
