...
class QuotationController extends Controller
{
    ...
    {
        $quotations = Quotation::sortable()->with('Status', 'DetailQuotation', 'Aplikator')->search(request(['search']))->status(request(['status']))->paginate(20);
        $statuses = Status::all();
    ...
    public function updateStatus(Request $request, Quotation $quotation)
    {
        ...
        $quotation->update([
            'status_quotation' => $validated['status_id'],
